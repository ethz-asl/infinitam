...
#include "DeviceSpecific/CUDA/ITMExtenalTracker_CUDA.h"
...
namespace ITMLib
{
  namespace Engine
  {
    ...
    public:
       ...
       */
      static ITMTracker *MakeExternalTracker(const Vector2i& trackedImageSize, const ITMLibSettings *settings, const ITMLowLevelEngine *lowLevelEngine,
                                        ITMIMUCalibrator *imuCalibrator, ITMScene<TVoxel,TIndex> *scene)
      {
        switch(settings->deviceType)
        {
